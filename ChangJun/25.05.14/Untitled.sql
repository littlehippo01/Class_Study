...
INSERT INTO `advise` VALUES ('P001','S001'),('P001','S002'),('P003','S003'),('P003','S004'),('P005','S005'),('P005','S006');
...
INSERT INTO `professor` VALUES ('P001','하은용','컴퓨터공학과','1001','경기도'),('P002','안창호','컴퓨터공학과','0002','서울'),('P003','이육사','국문학과','0003','강원도'),('P004','박종화','국문학과','0004','경상북도'),('P005','심훈','사학과','0005','전라남도'),('P006','한용운','사학과','0006','충청남도');
...
INSERT INTO `student` VALUES ('b002','관우','심리학과','010-222','서울'),('b003','장비','경제학과','010-333','서울'),('c002','여포','심리학과','016-222','경기'),('c003','손견','경제학과','016-333','경기'),('d001','홍길동','수학과','017-111','광주'),('S001','박소명','컴퓨터공학과','123-4567',NULL),('S002','최민국','컴퓨터공학과','234-5678',NULL),('S005','김상진','사학과','567-8901',NULL),('S006','황정숙','사학과','678-9012',NULL);
...
-- Dump completed on 2025-05-14 15:54:08
